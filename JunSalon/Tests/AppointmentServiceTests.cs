...
namespace Tests
{
    public class AppointmentServiceTests
    {
        ...
        public async Task BookAppointment_ShouldBeSuccessful_ForNewContact()
        {
            ...
            _appointmentRepoMock.Setup(x => x.AddAppointment(dummyBookingRecord, dummyAddedContactID)).ReturnsAsync(true);
        ...
        public async Task GetAppointmentsByContact_ShouldReturnListOfBookingRecords_ForContactWithAppointments()
        {
            ...
            _appointmentRepoMock.Setup(x => x.GetAppointmentsByContactID(dummyContactID)).ReturnsAsync(dummyBookingRecords);
